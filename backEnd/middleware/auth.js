...
module.exports = (req, res, next) => {
    try {
        ...
        const decodedToken = jwt.verify(token, process.env.SEC_TOKEN); // on utilise la fonction verify pour décoder le token. si il n'est pas validi une erreur est générée
